...
export default class SearchScreen extends Component {
  ...
  getMoreTransactions = async (searchText) => {
    var enteredText = searchText.toUpperCase().split("")
    var text = searchText.toUpperCase()

    const {lastVisibleTransaction} = this.state;
    if(enteredText[0] === "B"){
      ...
      <View style={styles.container}>
        ...
        <View style={styles.lowerContainer}>
          <FlatList
            ...
            onEndReached = {() => this.getMoreTransactions(this.state.searchText)}
          />
        </View>
      </View>
    );
